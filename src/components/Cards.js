  ...
  const cards = [
    {
      title: "Just Chatting",
      image: Chat,
      viewers: "338K viewers",
      type: "IRL",
    },
    {
      title: "League of Legends",
      image: lol,
      viewers: "153K viewers",
      type: "MOBA",
    },
    {
      title: "VALORANT",
    ...
    },
    {
      ...
      image: gta,
      viewers: "87.2K viewers",
      type: "FPS",
    },
    {
      title: "Counter-Strike: Global...",
      image: csgo,
      viewers: "71.5K viewers",
      type: "Shooter",
    },
    {
      title: "Apex Legends",
      image: apex,
      viewers: "59.9K viewers",
      type: "Shooter",
    },
    {
      title: "Fortnite",
      image: fortnite,
      viewers: "22.4K viewers",
      type: "Action",
    },
    { title: "Dota 2", image: dota, viewers: "31.6K viewers", type: "MOBA" },
    {
      title: "FIFA 23",
      image: fifa,
      viewers: "24.7K viewers",
      type: "Sports Game",
    },
    {
      title: "Overwatch 2",
      image: over,
      viewers: "23.9K viewers",
      type: "Shooter",
    },
    {
      title: "Hearthstone",
      image: stone,
      viewers: "22.3K viewers",
    ...
    {
      title: "Call of Duty: Modern W...",
      image: codmw,
      viewers: "11.8K viewers",
      type: "FPS",
    },
    {
      title: "Among Us",
        ...
        <div className="pt-4">
          <div className="flex items-center">
            ...
            <div className="flex items-center ml-3">
              <div className="absolute h-[1.50rem] p-3 w-auto flex rounded-l-md items-center justify-center">
                <BiSearch className="text-[20px] text-[#53535f]" />
              </div>
              <input
                type="search"
                placeholder="Search Category Tags"
                className="bg-[#e4e4e5] rounded-md placeholder-gray-600 placeholder-opacity-100  w-[15rem] pl-10 outline-none border-[#f7f7f8] border-[2.5px] hover:border-[#cbcbcb] hover:border-[2.5px] text-[13px] font-normal py-[5px] transition ease-out delay-100 focus:bg-[#f7f7f8] focus:border-[#5c16c5]"
              />
            </div>
          </div>
        </div>
        <div className="pt-6 items-center lg:flex hidden">
          <p className="text-[14px] mr-3">Sort by</p>
          <div className="flex items-center justify-center cursor-pointer h-8 w-[1rem] lg:w-[12rem] bg-[#e4e4e5] lg:text-[18px] rounded-md border-[2.5px] hover:border-[#cbcbcb] hover:border-[2.5px] text-[13px] font-normal py-[5px] transition ease-out delay-100 focus:bg-[#f7f7f8] focus:border-[#5c16c5]">
